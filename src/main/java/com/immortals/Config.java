...
public class Config {
    ...
    private static List<ConfigOption> buildOptions() {
        return List.of(
                ...
                new ConfigOption("frostbiteCooldown", 500, "Cooldown for frostbite ability (ticks)"),
                ...
                new ConfigOption("splinterBlowCombo", 4, "Number of hits required to trigger splinter blow"),
                new ConfigOption("splinterBlowDmg", 0.15, "Damage dealt by splinter blow as a fraction of max HP"),
                new ConfigOption("linkDuration", 800, "Duration of link ability (ticks)"),
                new ConfigOption("linkRadius", 15.0, "Radius for link ability (blocks)"),
                new ConfigOption("linkCooldown", 1200, "Cooldown for link ability (ticks)"),
                new ConfigOption("waveRadius", 15.0, "Distance to remove cobwebs (blocks)"),
                ...
                new ConfigOption("fractalEdgeDmg", 0.45, "Damage dealt by fractal as a fraction of max HP"),
                new ConfigOption("fractalEdgeHits", 7, "Number of edge hits to trigger fractal edge"),
                ...
                new ConfigOption("blinkThreshold", 14.0, "Health to activate blink at (health)"),
                ...
                new ConfigOption("maxSpellSlots", 4,
