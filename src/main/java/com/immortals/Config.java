...
public class Config {
    ...
    private static List<ConfigOption> buildOptions() {
        return List.of(
                ...
                new ConfigOption("gambleMin", 6.0, "Minimum health during gamble"),
                new ConfigOption("gambleMax", 32.0, "Maximum health during gamble"),
                new ConfigOption("gambleDuration", 160, "Duration of gamble effect (ticks)"),
                new ConfigOption("gambleCooldown", 600, "Cooldown for gamble ability (ticks)"),
                new ConfigOption("waveRadius", 15, "Distance to remove cobwebs (blocks)"),
