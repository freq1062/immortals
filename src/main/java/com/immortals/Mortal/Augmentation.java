...
public class Augmentation {
        ...
        static {
                ...
                swordAttrs.add(new AttributeConfig(EntityAttributes.MOVEMENT_SPEED, 0.01f));
                ...
                // Other attributes
                shieldAttrs.add(new AttributeConfig(EntityAttributes.ATTACK_DAMAGE, 1.0f));
                ...
                totemAttrs.add(new AttributeConfig(EntityAttributes.ARMOR_TOUGHNESS, 4f));
